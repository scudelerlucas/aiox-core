...
// `falhou` já nasce dos achados derivados acima; o piso e as medições exigidas somam nele.
...
console.log(
  "%s",
  falhou === 0
    ? `\n${String(PARES.length)} pares verificados (piso ${String(PISO_DE_PARES)}, ` +
        `${String(MEDICOES_EXIGIDAS.length)} exigidas por nome), todos dentro da régua.`

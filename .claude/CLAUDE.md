...
> **Formato de resposta ao Lucas (regra permanente):** toda resposta segue (1) Resumo simples, (2) Decisões a tomar, (3) Recomendação + porquê, (4) Riscos de cada opção, (5) Passo a passo com links. Detalhes: `.claude/rules/response-format-lucas.md`.
